...
class RaycastRenderer(ABC):
    ...
    def visualize(self):
        ...
        if self.mode == RenderMode.MULTI_VOLUME or self.mode == RenderMode.QUICK_MULTI:
        ...
        elif self.mode == RenderMode.QUICK_MULTI:
            self.render_mouse_brain(view_matrix_transposed, self.annotation_volume, self.energy_volumes,
                                    self.challenge_image_size, self.challenge_image, True)
        else:
