...
RADIO_LABELS = {RenderMode.SLICER: "Slicer", RenderMode.MIP: "MIP", RenderMode.COMPOSITING: "Compositing", RenderMode.MULTI_VOLUME: "Challenge data", 
                RenderMode.QUICK_MULTI: "Quick slice"}
...
class RaycastTab(wx.Panel):
    def __init__(self, parent, handle_event_radio_button):
        ...
        self.quickmulti_button = wx.RadioButton(self, label=RADIO_LABELS[RenderMode.QUICK_MULTI])
        ...
        sizer.Add(self.quickmulti_button)
        self.SetSizer(sizer)
    ...
    def on_radio_button(self, event):
        ...
        elif self.quickmulti_button.GetValue():
            mode = RenderMode.QUICK_MULTI
        else:
